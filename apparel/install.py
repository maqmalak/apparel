...
def _build_custom_fields():
    ...
    # ---------------------------------------------------------- Sales Order Item
    add("Sales Order Item", "style_no", "Style No.", "Data", None, "apparel_export_break", None)
...
def create_roles():
    for role in ["Apparel Administrator", "Export Manager", "Import Manager", "Commercial Manager"]:
        if not frappe.db.exists("Role", role):
            frappe.get_doc({"doctype": "Role", "role_name": role}).insert(ignore_permissions=True)
    # Assign the apparel workflow roles to Administrator so the workflow
    # action buttons (Submit / Approve / ...) actually render in the UI.
    for role in ["Export Manager", "Apparel Administrator"]:
...
def create_workflow():
    ...
    states = [
        ...
        {"state": "Closed", "doc_status": 1, "allow_edit": "Apparel Administrator"},
    ]
    transitions = [
        ...
        {"state": "Confirmed", "action": "Close", "next_state": "Closed", "allowed": "Apparel Administrator"},
        {"state": "Confirmed", "action": "Reopen", "next_state": "LC Received", "allowed": "Apparel Administrator"},
    ]
    doc = frappe.get_doc(
        {
            "doctype": "Workflow",
...
NUMBER_CARDS = [
    ("Apparel LC Proformas", "Count", "LC Proforma", None, "Apparel"),
    ("Apparel LC Value", "Sum", "LC Proforma", "lc_amount", "Apparel"),
    ("Apparel LC Pending", "Count", "LC Proforma", None, "Apparel",
     [["lc_status", "in", ["Submitted", "Buyer Approval", "LC Requested", "LC Received"]]]),
    ("Apparel LC Expiring", "Count", "LC Proforma", None, "Apparel",
     [["lc_expiry_date", "Between", None, "next_gte_30"]]),
    ("Apparel Export Orders", "Count", "Sales Order", None, "Apparel",
     [["export_order_flag", "=", None, "is_set"]]),
    ("Apparel Pending Export Orders", "Count", "Sales Order", None, "Apparel",
     [["export_status", "in", ["Planned", "In Production", "Ready to Ship"]]]),
    ("Apparel Shipments Pending", "Count", "Export Shipment", None, "Apparel",
     [["shipment_status", "not in", ["Arrived", "Delivered", "Closed"]]]),
    ("Apparel Shipments In Transit", "Count", "Export Shipment", None, "Apparel",
     [["shipment_status", "=", "In Transit"]]),
    ("Apparel Export Value", "Sum", "Sales Order", "grand_total", "Apparel",
     [["export_order_flag", "=", None, "is_set"]]),
    ("Apparel Pending Shipment Value", "Sum", "Sales Order", "grand_total", "Apparel",
     [["export_status", "in", ["Planned", "In Production", "Ready to Ship"]]]),
]
...
def create_dashboard():
    ...
    # Charts
    charts = [
        ("Apparel Monthly Export Value", "Sum", "Sales Order", "transaction_date", "grand_total", "Bar",
         [["export_order_flag", "=", None, "is_set"]]),
        ("Apparel Buyer-wise Export Value", "Sum", "Sales Order", "customer", "grand_total", "Pie",
         [["export_order_flag", "=", None, "is_set"]]),
        ("Apparel LC Status", "Group By", "LC Proforma", "lc_status", None, "Pie", None, "lc_status"),
        ("Apparel Shipment Status", "Group By", "Export Shipment", "shipment_status", None, "Pie", None, "shipment_status"),
        ("Apparel Country-wise Export", "Group By", "Sales Order", "country_of_destination", None, "Pie",
         [["export_order_flag", "=", None, "is_set"]], "country_of_destination"),
        ("Apparel Buyer-wise Pending Orders", "Count", "Sales Order", "customer", None, "Bar",
    ...
    # Dashboard
    dash_name = "Apparel Export Dashboard"
...
def create_workspace():
    ...
    # /desk/apparel so it shows in the sidebar and app switcher.
    ...
    content = [
        {"id": "header1", "type": "header", "data": {"text": "<span class=\"h4\"><b>Apparel</b></span>", "col": 12}},
